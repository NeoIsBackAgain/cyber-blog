...
tags:
  - blog
  - Misc
lastmod: 2026-07-24T06:39:45.875Z
---
...
```
{{ $pages := where .Site.RegularPages "Params.tags" "intersect" (slice "Misc" "misc" "Miscellaneous" "miscellaneous") }}
```

**windows**

```
{{ len (where .Site.RegularPages "Params.tags" "intersect" (slice "note-windows" "note-Windows" "note-Window" "note-window" "note-ad"  "note-active directory ")) }} Posts

```

### 7️⃣ canvas Shortcode

Display canvans

**File:** `layouts/shortcodes/canvas.html`
...
**Output:** Displays obsidian 's  canvas
