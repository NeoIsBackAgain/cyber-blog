...
tags:
  - blog
  - note-ad
  - windows-firewall-Static-Analysis
  - windows-defender-shellcode-bypass-shell-rce
  - windows-bypass-asmi
  - windows-bypass-amsi
lastmod: 2026-07-24T07:34:26.123Z
---
# Box Info
...
{{< tag "windows-firewall-Static-Analysis" >}} The malware is blocked by windows defender ,and I can use the Get-MpThreat and Get-MpThreatDetection to know why I am blocked powershell.
...
{{< tag "Dynamic Analysis" >}} Using the ThreatCheck which is likely the windows defender detection tools , to know the malware can bypass the defender or not
...
{{< tag "windows-defender-shellcode-bypass-shell-rce" >}} In the windows defender , using the micr0\_shell to help us bypassing windows defender to have the shell rce for not being detected .
...
{{< tag "windows-bypass-asmi" >}} bypass windows firewall with asmi to let the powershell to run , using following method to bypass.
...
{{< tag "windows-bypass-amsi" >}} bypass the windows asmi to let my Red-team tool like mimikatz , Rubeus .ps1 to run successfully.
