...
lastmod: 2026-04-27T08:23:24.963Z
---
# Box Info
...
{{< tag "Port53-DNS-Discovery-Host" >}} Found 2 commonName (which is the DNS resolve) in 443 ssl sert  , so need to add into the  `sudo vim /etc/hosts`
